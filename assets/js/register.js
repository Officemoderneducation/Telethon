...
registerForm.addEventListener("submit", async (e) => {
    ...
    if (!/^\d{4}$/.test(password.value)) {
        ...
        message.innerHTML = "Password must be exactly 4 digits.";
    ...
    const employeeQuery = query(
        ...
        where("employeeCode", "==", employeeCode.value.trim())
    ...
    if (!employeeSnapshot.empty) {
        ...
        message.style.color = "red";
        message.innerHTML = "Employee Code already exists.";
...
const employeeData = {
    ...
    jamiatulMadina: jamiatulMadina.value.trim(),
...
try {
    ...
    await setDoc(
        ...
        doc(db, "employees", employeeCode.value.trim()),
